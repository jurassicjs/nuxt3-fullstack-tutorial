        ...
        <div
          ...
          <div class="dark:bg-slate-800 bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            ...
            <button type="button" @click="$emit('rehide')"
              class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 dark:bg-slate-800 dark:text-white bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
              {{dismissText}}
            </button>
          </div>
        </div>
